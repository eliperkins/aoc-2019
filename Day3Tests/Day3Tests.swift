...
class Day3Tests: XCTestCase {
    ...
    func testPartOneExamples() {
        XCTAssertEqual(distanceFromCentralPort(for: "R8,U5,L5,D3", and: "U7,R6,D4,L4"), 6)
        XCTAssertEqual(
            distanceFromCentralPort(
                for: "R75,D30,R83,U83,L12,D49,R71,U7,L72",
                and: "U62,R66,U55,R34,D71,R55,D58,R83"
            ),
            159
        )
        XCTAssertEqual(
            distanceFromCentralPort(
                for: "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51",
                and: "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
            ),
            135
        )
    }
    ...
    func testPartOneAnswer() {
        XCTAssertEqual(distanceFromCentralPort(for: lhsInput, and: rhsInput), 1195)
    }

    func testPartTwoExamples() {
        XCTAssertEqual(distanceWithShortestSteps(for: "R8,U5,L5,D3", and: "U7,R6,D4,L4"), 30)
        XCTAssertEqual(
            distanceWithShortestSteps(
                for: "R75,D30,R83,U83,L12,D49,R71,U7,L72",
                and: "U62,R66,U55,R34,D71,R55,D58,R83"
            ),
            610
